...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','upload','link','unlink'],
...
var nicEditorFontFamilySelect = nicEditorSelect.extend({
	sel : {'arial' : 'Arial','courier new' : 'Courier New','georgia' : 'Georgia', 'helvetica' : 'Helvetica', 'impact' : 'Impact', 'times new roman' : 'Times', 'trebuchet ms' : 'Trebuchet', 'verdana' : 'Verdana'},
  ...
  uploadFile : function() {
    ...
    xhr.onload = function() {
      try {
        ...
        return this.onError("JSON decode: "+xhr.responseText);
      }
