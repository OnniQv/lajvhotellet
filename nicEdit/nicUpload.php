...
else
{
  ...
  die(json_encode(array("upload"=>array(  "link" => "/nicEdit/uploads/".$_FILES['image']['name'], "width" => "100"))));
  
  
  
define('NICUPLOAD_PATH', '/nicEdit/uploads'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', '/nicEdit/uploads');   // Set the URL (relative or absolute) to
